export const MetaData = {
  title: {
    default: "Selamat Datang Di Halaman Login dan Registrasi",
    template: "%s | RT 50",
  },
  description:
    "Selamat datang di halaman login dan registrasi RT 50 – Profil, Agenda & Berita Warga",
  keywords: ["RT50", "RT 50", "agenda warga", "berita RT"],
  authors: [{ name: "Ketua RT 50", url: "https://rt50.example.com" }],
  openGraph: {
    title: "RT 50",
    description:
      "Dashboard Website Resmi RT 50 – Profil, Agenda & Berita Warga",
